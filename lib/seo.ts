...
export const siteName = "StreamSync";
export const siteUrl = process.env.APP_URL || "https://media-downloader.example.com";
export const siteDescription =
  "StreamSync is a fast media downloader for YouTube, Instagram, Facebook, TikTok and more.";

export const seoPages: Record<SeoPageKey, SeoPageConfig> = {
  home: {
    slug: "/",
    title: "Media Downloader - Download Videos From Anywhere",
    description: "Download high quality videos, audio and images from popular platforms with a fast, simple media downloader.",
    keywords: ["media downloader", "video downloader", "audio downloader", "social media downloader"],
  ...
  youtube: {
    slug: "/youtube",
    title: "YouTube Downloader - Download Videos and Audio",
    description: "Download YouTube videos and audio in available formats with a clean, fast downloader.",
    keywords: ["youtube downloader", "download youtube video", "youtube to mp3", "youtube to mp4"],
  ...
  instagram: {
    slug: "/instagram",
    title: "Instagram Downloader - Download Reels and Posts",
    description: "Download Instagram reels, posts and videos in available formats without changing your workflow.",
    keywords: ["instagram downloader", "download instagram reel", "instagram video downloader"],
  ...
  facebook: {
    ...
    description: "Download public Facebook videos quickly and choose from the available formats.",
  ...
  tiktok: {
    ...
    description: "Download TikTok videos in the available formats using a simple, fast downloader.",
    keywords: ["tiktok downloader", "download tiktok video", "tiktok video downloader"],
  ...
  "how-to": {
    slug: "/how-to",
    title: "How To Download Media - Step by Step Guide",
    description: "Learn how to use StreamSync to download media from supported platforms.",
    keywords: ["how to download video", "download guide", "media downloader guide"],
