...
export const featurePages: FeaturePage[] = [
  ...
  { slug: "download-playlist", title: "Download Playlist - Save Multiple Items Efficiently", description: "Guide users through downloading items one by one from a supported playlist flow.", h1: "Download Playlist", intro: "Use Pullify as the starting point for saving a sequence of supported items.", iconKey: "list", benefits: ["Helpful batch workflow", "Keeps downloads organized", "Pairs with the queue UI"], steps: ["Open the supported playlist link.", "Fetch the media items.", "Add each item you want to the queue."], faqs: [{ question: "Is playlist downloading automatic?", answer: "The downloader is optimized for single links, but you can process items sequentially from a playlist." }] },
  ...
  { slug: "download-reels", title: "Download Reels - Save Reels in Available Formats", description: "Save reels from supported platforms while preserving the existing download flow.", h1: "Download Reels", intro: "Use Pullify to fetch reels and download the available media formats.", iconKey: "film", benefits: ["Built for reels", "Fast format lookup", "Maintains your workflow"], steps: ["Copy the reel link.", "Paste it here and fetch the media.", "Download the format that fits your needs."], faqs: [{ question: "Are reels supported?", answer: "Yes, supported reel links can be processed through the downloader." }] },
...
export const comparisonPages: ComparisonPage[] = [
  { slug: "y2mate-alternative", title: "Y2Mate Alternative - Faster Media Downloader", description: "Compare Pullify as an alternative with a cleaner interface and simpler workflow.", h1: "Y2Mate Alternative", intro: "Pullify provides a focused downloader flow without extra distractions.", iconKey: "arrow", comparisonPoints: ["Cleaner interface", "Direct format selection", "Shared queue and history"], faqs: [{ question: "Why use this alternative?", answer: "It keeps the existing workflow minimal and focused on the download task." }] },
  ...
  { slug: "snaptik-alternative", title: "Snaptik Alternative - TikTok Video Downloader", description: "Show Pullify as a TikTok-focused alternative with the same downloader flow.", h1: "Snaptik Alternative", intro: "The TikTok page and downloader experience stay the same while improving discoverability.", iconKey: "music", comparisonPoints: ["TikTok-specific entry point", "Format list stays intact", "Keeps the same UI"], faqs: [{ question: "Does it work for TikTok?", answer: "Yes, use the TikTok page or the alternative landing page to access the same downloader." }] },
];
